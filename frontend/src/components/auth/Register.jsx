...
import { FaUser, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaRobot, FaArrowRight, FaMoon, FaSun, FaGoogle } from 'react-icons/fa';

const Register = () => {
  const [formData, setFormData] = useState({ name: '', email: '', password: '' });
  const [showPassword, setShowPassword] = useState(false);
  const { register, loading, error, clearError, loginWithGoogle } = useAuthStore();
